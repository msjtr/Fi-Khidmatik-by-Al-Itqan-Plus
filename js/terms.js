// ========================================
// صفحات الشروط والأحكام - النسخة الكاملة والمطابقة للمحتوى الأصلي
// ========================================
    ...
    return '<div class="page">' +
        ...
        '<div class="terms-container">' +
            '<div class="terms-grid">' +
                ...
                '</div>' +
                '<div>' +
                    '<div class="terms-card"><h4>الشروط الإضافية والملحقات</h4>' +
                    ...
                    '<div class="declaration" style="background-color: #e8f4fd; border-right: 4px solid #004085; padding: 15px; margin: 20px 0;">' +
                        '<p><strong>الإقرار</strong></p>' +
                        '<p>أقر أنا العميل بالاطلاع على جميع الشروط والأحكام أعلاه وأوافق عليها بالكامل وأتعهد بالالتزام بها دون أي استثناء.</p>' +
                    '</div>' +
                    '<div class="signature-area" style="margin-top: 20px; padding: 15px; border: 1px solid #ddd;">' +
                        '<div><strong>اسم العميل:</strong> ' + window.escapeHtml(order.customerName) + '</div>' +
