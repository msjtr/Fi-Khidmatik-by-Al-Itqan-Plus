                ...
                <form id="product-main-form">
                    <div style="display:grid; grid-template-columns: 2fr 1fr; gap:20px; margin-bottom:20px;">
                        ...
                        <div>
                            ...
                            <input type="text" id="p-code" required placeholder="SW-100" style="width:100%; padding:12px; border-radius:10px; border:1px solid #e2e8f0;">
                        </div>
                    </div>

                    <div style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap:20px; margin-bottom:20px;">
                        <div>
                            <label style="font-weight:700; display:block; margin-bottom:8px;">السعر (SAR)</label>
                        ...
                        <div>
                            <label style="font-weight:700; display:block; margin-bottom:8px;">الكمية</label>
