// ========================================
// invoice.js - دوال إنشاء الفاتورة الإلكترونية (مع معالجة المسارات النسبية و CORS)
// ========================================
...
// صورة placeholder (استخدم مساراً مطلقاً لصورة حقيقية)
const PLACEHOLDER_IMAGE = "/fi-khidmatik/admin/images/default-product.png";
...
function toAbsoluteImageUrl(url) {
    ...
    // افتراض أن المجلد الجذر للمشروع هو /fi-khidmatik/
...
function getFinalImageUrl(imageUrl) {
    if (!imageUrl) return toAbsoluteImageUrl(PLACEHOLDER_IMAGE);
    let absoluteUrl = toAbsoluteImageUrl(imageUrl);
...
// ========================================
// صفحة الفاتورة الرئيسية (مع وكيل للصور وتحويل المسارات)
// ========================================
        ...
        itemsHtml += `
            <tr>
                ...
                <td style="text-align:center">
                    <img src="${finalImageUrl}" class="product-img" style="width:45px;height:45px;object-fit:cover;" onerror="this.src='${toAbsoluteImageUrl(PLACEHOLDER_IMAGE)}'">
                </td>
